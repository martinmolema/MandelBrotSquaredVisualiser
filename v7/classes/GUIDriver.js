...
export class GUIDriver {
    ...
    setupCanvas(){
        ...
        localStorage.setItem("CANVAS_WIDTH",  this.canvas.width);
        localStorage.setItem("CANVAS_HEIGHT", this.canvas.height);

    }// setupCanvas()

    initConstants(){
        this.constants        = new ConstantsWithPixels(this.canvas, 0, 0, 0, 0);
    ...
    showBoundingBoxInfo() {
        ...
        this.elmZoomfactor.textContent = Math.ceil(1 / this.constants.boundingbox.dimensions.w).toString();
    }// showBoundingBoxInfo()
    ...
    adjustCanvasDimensions(fractal_plane_height) {
        ...
        this.constants.updateCanvas(this.canvas);
        ...
        this.svgOverlay.setAttribute("width",  this.canvas.width);
        this.svgOverlay.setAttribute("height", this.canvas.height);

        this.elmCanvasWidthText.textContent  = this.canvas.width.toString();
        this.elmCanvasHeightText.textContent = this.canvas.height.toString();
